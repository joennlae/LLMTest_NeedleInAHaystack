...
NIAH_EVALUATOR_API_KEY=unused NIAH_MODEL_API_KEY=unused needlehaystack.run_test --provider openai --model_name "TheBloke/Nous-Hermes-2-Mixtral-8x7B-DPO-GPTQ" --document_depth_percents "[5, 20, 40, 60, 80, 95]" --context_lengths "[1000, 2000, 4000, 6000, 8000, 10000, 12000, 14000, 16000, 18000, 20000, 22000, 24000, 26000, 28000, 30000, 32000]" --base_url "https://3gccynckfupbqo-8000.proxy.runpod.net/v1/" --evaluator_model_name "TheBloke/Nous-Hermes-2-Mixtral-8x7B-DPO-GPTQ"
```